...
def add_id2prop(id_str,args):
	ids = id_str.split(',')
	for id in ids:
		id2prop[id].append(args[0])
		id2args[id].append(args)
...
prepositions = {'abaft': 1, 'aboard': 1, 'about': 1, 'above': 1, 'absent': 1,
                'across': 1, 'afore': 1, 'after': 1, 'against': 1, 'along': 1,
                'alongside': 1, 'amid': 1, 'amidst': 1, 'among': 1,
                'amongst': 1, 'around': 1, 'as': 1, 'aside': 1, 'astride': 1,
                'at': 1, 'athwart': 1, 'atop': 1, 'barring': 1, 'before': 1,
                'behind': 1, 'below': 1, 'beneath': 1, 'beside': 1,
                'besides': 1, 'between': 1, 'betwixt': 1, 'beyond': 1,
                'but': 1, 'by': 1, 'concerning': 1, 'despite': 1,
                'during': 1, 'except': 1, 'excluding': 1, 'failing': 1,
                'following': 1, 'for': 1, 'from': 1, 'given': 1,
                'in': 1, 'including': 1, 'inside': 1, 'into': 1,
                'lest': 1, 'like': 1, 'minus': 1, 'modulo': 1, 'near': 1,
                'next': 1, 'of': 1, 'off': 1, 'on': 1, 'onto': 1,
                'opposite': 1, 'out': 1, 'outside': 1, 'over': 1,
                'pace': 1, 'past': 1, 'plus': 1, 'pro': 1, 'qua': 1,
                'regarding': 1, 'round': 1, 'sans': 1, 'save': 1,
                'since': 1, 'than': 1, 'through': 1, 'throughout': 1,
                'till': 1, 'times': 1, 'to': 1, 'toward': 1, 'towards': 1,
                'under': 1, 'underneath': 1, 'unlike': 1, 'until': 1,
                'up': 1, 'upon': 1, 'versus': 1, 'via': 1, 'vice': 1,
                'with': 1, 'within': 1, 'without': 1, 'worth': 1}
...
def main():
    ...
    parser.add_argument('--nonmerge', help='Add nonmerge constraints. '
                        ...
                        'sameidall (ALL args of preds with same id cannot be merged), '
    ...
    sameidall = 'sameidall' in pa.nonmerge
    ...
    for line in lines:
        ...
        # Parse propositions
            ...
            if sameidall: ofile.write(generate_sameIDall_nm())
