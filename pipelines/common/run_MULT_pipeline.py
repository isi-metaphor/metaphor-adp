...
if __name__ == '__main__':
    ...
    fa_metaphors = {'id2': 'باراک اوباما، رئیس جمهوری آمریکا، با پیروزی در برابر میت رامنی، رقیب جمهوریخواه خود، چهار سال دیگر در مقام خود باقی می<U+200C>ماند. آقای رامنی شکست خود در انتخابات را پذیرفته و به آقای اوباما تبریک گفته است.','id4': 'برخی از وبسایت های خبری گزارش کرده اند که ستار بهشتی، وبلاگ نویسی که گفته می<U+200C>شود در هفتم آبان توسط پلیس ایران بازداشت شده بوده، کشته شده است.'}
