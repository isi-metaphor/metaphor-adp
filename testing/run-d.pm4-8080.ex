...
# Rebuild automatic KBs and run the dev. set for each language
...
./test -l en -i $IDENTIFIER \
       ...
       data/EN.dev > en-d.pm4-8080.ex.$IDENTIFIER.txt &
#./test -l es -i $IDENTIFIER \
#       -u http://colo-pm4.isi.edu:8080 -p '/home/metaphor/kbs/' \
#       data/ES.dev > es-d.pm4-8080.ex.$IDENTIFIER.txt &
#./test -l fa -i $IDENTIFIER \
#       -u http://colo-pm4.isi.edu:8080 -p '/home/metaphor/kbs/' \
#       data/FA.dev > fa-d.pm4-8080.ex.$IDENTIFIER.txt &
#./test -l ru -i $IDENTIFIER \
#       -u http://colo-pm4.isi.edu:8080 -p '/home/metaphor/kbs/' \
#       data/RU.dev > ru-d.pm4-8080.ex.$IDENTIFIER.txt &
