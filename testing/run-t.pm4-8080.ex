...
./test -l en -i $IDENTIFIER \
       ...
       data/EN.test > en-t.pm4-8080.ex.$IDENTIFIER.txt &
./test -l es -i $IDENTIFIER \
       -u http://colo-pm4.isi.edu:8080 -p '/home/metaphor/kbs/' \
       data/ES.test > es-t.pm4-8080.ex.$IDENTIFIER.txt &
./test -l fa -i $IDENTIFIER \
       -u http://colo-pm4.isi.edu:8080 -p '/home/metaphor/kbs/' \
       data/FA.test > fa-t.pm4-8080.ex.$IDENTIFIER.txt &
./test -l ru -i $IDENTIFIER \
       -u http://colo-pm4.isi.edu:8080 -p '/home/metaphor/kbs/' \
       data/RU.test > ru-t.pm4-8080.ex.$IDENTIFIER.txt &
