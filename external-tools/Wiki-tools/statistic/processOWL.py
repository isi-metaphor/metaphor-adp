...
def main():
    ...
    parser.add_option("-f", "--file", dest="filePath",
                      help="the *.owl files dir path")
    parser.add_option("-o", "--outputfile", dest="outPath",
                      help="the hierachical files dir path")
