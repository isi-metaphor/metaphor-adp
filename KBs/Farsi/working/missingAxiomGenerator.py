...
var_name_values = {"source": "", "target": "", "sourceConceptSubDomain": "",
                   "sourceFrame": "", "targetConceptDomain": "",
                   "targetConceptSubDomain": "", "targetFrame": ""}
...
for jsonFileName in listOfJsonFiles:
    ...
    for varName in var_name_values:
        for line in lines:
            if varName in line: 
                if varName == "source" and not isFirstSourceNode:
                    continue
